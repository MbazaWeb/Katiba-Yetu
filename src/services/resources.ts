...
export const resourceLibrary: ResourceEntry[] = [
  ...
  },
  {
    ...
    description: 'Rasimu ya Katiba iliyowasilishwa na Tume ya Mabadiliko ya Katiba mwaka 2014.',
    category: 'draft_constitution',
    fileType: 'pdf',
    year: 2014,
    language: 'sw',
    url: null,
  ...
  {
    id: 'res-crc-report',
    title: 'Ripoti ya Tume ya Mabadiliko ya Katiba',
    description: 'Ripoti ya mwisho ya Tume ya Mabadiliko ya Katiba inayoelezea mchakato na mapendekezo.',
    category: 'report',
    fileType: 'pdf',
    year: 2014,
    language: 'sw',
  ...
  {
    id: 'res-wanjala-edu',
    title: 'Mwongozo wa Elimu ya Katiba kwa Wananchi',
    description: 'Rasilimali ya elimu inayolenga kuelezea muundo na maana ya Katiba kwa lugha rahisi.',
