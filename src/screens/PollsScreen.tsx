      ...
      <ScrollView contentContainerStyle={styles.content}>
        <View style={styles.hero}>
          <View style={styles.heroIcon}>
            <Ionicons name="stats-chart" size={24} color={Colors.gold[300]} />
          </View>
          <View style={styles.heroTextBlock}>
            <Text style={styles.heroTitle}>
              {t('Sauti yako ina umuhimu', 'Your voice matters', language)}
            </Text>
            <Text style={styles.heroBody}>
              {t(
                'Shiriki kwenye kura za ushauri kuhusu ibara za Katiba.',
                'Take part in advisory polls about constitutional articles.',
                language,
              )}
            </Text>
          </View>
        ...
        <View style={styles.stats}>
          ...
          <Stat value={formatCount(totalVotes)} label={t('Kura zote', 'Total votes', language)} />
          <View style={styles.divider} />
          <Stat value={String(sectionCount)} label={t('Ibara', 'Articles', language)} />
        </View>
        ...
        <View style={styles.notice}>
          ...
          <Text style={styles.noticeText}>
            {t(
              'Kura ni za ushauri. Majibu yako yanawekwa kwa usalama na faragha.',
              'Polls are advisory. Your responses are stored securely and privately.',
              language,
            )}
          </Text>
        </View>
